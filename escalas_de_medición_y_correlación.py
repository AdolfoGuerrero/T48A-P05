...
Original file is located at
    https://colab.research.google.com/drive/1XeCkRjkC0M8afqCwkRYgr11vfT_WpJPj
...
def regresion_lineal(x, y):
    ...
    std_x = np.std(x, ddof=1)
    std_y = np.std(y, ddof=1)
    r_value = sum((x - mean_x) * (y - mean_y)) / ((n - 1) * std_x * std_y)

    return (slope, intercept, r_value)

def regresion_lineal_model_3():
    years = np.array([2020, 2021, 2022, 2023, 2024])
    prices = np.array([39990, 41990, 43990, 45990, 47990])
    return regresion_lineal(years, prices)

print(regresion_lineal_model_3())

def regresion_lineal_model_s():
    years = np.array([2020, 2021, 2022, 2023, 2024])
    prices = np.array([89990, 91990, 93990, 95990, 97990])
    return regresion_lineal(years, prices)

print(regresion_lineal_model_s())

def regresion_lineal_model_x():
    years = np.array([2020, 2021, 2022, 2023, 2024])
    prices = np.array([99990, 101990, 103990, 105990, 107990])
    return regresion_lineal(years, prices)

print(regresion_lineal_model_x())

def regresion_lineal_model_y():
    years = np.array([2020, 2021, 2022, 2023, 2024])
    prices = np.array([44990, 46990, 48990, 50990, 52990])
    return regresion_lineal(years, prices)

print(regresion_lineal_model_y())